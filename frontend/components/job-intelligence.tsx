...
type Job = {
  ...
  education: string | null; experience: string | null; eligibility: string | null; sponsorship_information: string | null; mode: "demo" | "live";
...
export function JobIntelligence({ onNavigate }: { onNavigate?: (tab: "Resume" | "Job Intelligence" | "Interview" | "Applications" | "AI Society") => void }) {
  ...
  return (
    <section className="rounded-xl border border-white/10 bg-white/[0.03] p-5 md:col-span-3">
      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-[1fr_1.2fr]">
        ...
        {selected ? <JobDetail job={selected} match={match} matchMessage={matchMessage} onNavigate={onNavigate} onAnalyze={async () => {
